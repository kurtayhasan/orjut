  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-300 selection:bg-emerald-500/20">
      <div className="max-w-4xl mx-auto px-6 py-24">
        <Link href="/en" className="inline-flex items-center gap-2 text-zinc-500 hover:text-emerald-500 transition-colors font-bold text-xs uppercase tracking-widest mb-12 group">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tighter">Privacy Policy</h1>
        </div>

        <div className="prose prose-invert prose-emerald max-w-none space-y-8 text-lg font-medium leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">1. Data Collection and Usage</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">2. Account Security</h2>
            <p>
        ...
        <div className="mt-24 pt-12 border-t border-white/5 text-center">
          <p className="text-xs font-bold text-zinc-600 uppercase tracking-widest">Last Updated: May 6, 2026</p>
        </div>
      </div>
    </div>
  );
