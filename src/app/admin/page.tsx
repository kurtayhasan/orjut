...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 min-h-screen bg-zinc-50 dark:bg-bg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 space-y-2">
          <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
            <Users size={18} />
            <span className="text-xs font-bold uppercase tracking-widest">Toplam Kullanıcı</span>
          </div>
        ...
        <Card className="p-6 space-y-2">
          <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Premium Abone</span>
          </div>
          <p className="text-4xl font-bold">{metrics.totalPremium}</p>
        </Card>

        <Card className="p-6 space-y-2">
          <div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
            <Map size={18} />
            <span className="text-xs font-bold uppercase tracking-widest">Toplam Arazi</span>
          </div>
          <p className="text-4xl font-bold">{metrics.totalLands}</p>
        </Card>
      </div>
      ...
      <Card className="overflow-hidden border-none shadow-xl">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-zinc-50 dark:bg-zinc-900 text-[10px] font-bold uppercase tracking-widest text-zinc-500">
              <tr>
                ...
                pendingApprovals.map(u => (
                  <tr key={u.id}>
                    ...
                    <td className="px-6 py-4">
                      <span className="px-2 py-1 bg-amber-100 text-amber-600 text-[10px] font-bold uppercase rounded">
                        Onay Bekliyor
                      </span>
                    </td>
