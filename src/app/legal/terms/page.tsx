    ...
    <div className="min-h-screen bg-[#050505] text-zinc-300 selection:bg-emerald-500/20">
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tighter">Kullanım Koşulları</h1>
        </div>

        <div className="prose prose-invert prose-blue max-w-none space-y-8 text-lg font-medium leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">1. Hizmet Kapsamı</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">2. Abonelik ve Ödemeler</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">4. Hizmet Kesintileri</h2>
            <p>
