    ...
    <div className="min-h-screen bg-[#050505] text-zinc-300 selection:bg-emerald-500/20">
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tighter">Gizlilik Politikası</h1>
        </div>

        <div className="prose prose-invert prose-emerald max-w-none space-y-8 text-lg font-medium leading-relaxed">
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">1. Veri Toplama ve Kullanımı</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">2. Hesap Güvenliği</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">3. Üçüncü Taraf Paylaşımı</h2>
            <p>
        ...
        <div className="mt-24 pt-12 border-t border-white/5 text-center">
          <p className="text-xs font-bold text-zinc-600 uppercase tracking-widest">Son Güncelleme: 6 Mayıs 2026</p>
        </div>
      </div>
    </div>
  );
