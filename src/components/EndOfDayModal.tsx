      ...
      {!closed ? (
        <>
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight leading-tight">Bugünkü operasyonları tamamladınız mı?</h3>
          ...
          <div className="bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-2xl p-5 mb-8 space-y-2 text-center">
            <p className="text-xs font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mb-2">Günün Özeti</p>
            <p className="text-sm text-zinc-600 dark:text-zinc-400 font-bold leading-relaxed">
              Bugün: <span className="font-bold text-rose-600 dark:text-rose-400">₺{dailySpent.toLocaleString()}</span> Masraf<br/>
              Kazanç: <span className="font-bold text-emerald-600 dark:text-emerald-400">₺{totalSavings.toLocaleString()}</span> Tasarruf
            </p>
          </div>
        ...
        <>
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">Gün Kapatıldı!</h3>
