        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="flex-1 py-2 bg-white/10 text-white text-[11px] font-black uppercase tracking-wider rounded-xl hover:bg-emerald-500 hover:text-white transition-all shadow-sm"
            >
              Anladım ve Kabul Et
            </button>
            <button 
